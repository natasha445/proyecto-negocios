...
const CheckoutContent = ({ totalPrice, name, includesFreeShipping}) => {
    const dispatch = useDispatch();
    const totalPriceWithShipping = includesFreeShipping ? totalPrice : totalPrice + 5.99;
        ...
        <div>
            <div className="w-[95%] sm:w-[80%] lg:w-[50%] mx-auto px-8 py-12 shadow-lg rounded-xl">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <span className="italic font-bold">{formatPrice(totalPriceWithShipping)}</span>
                </div>
            </div>
