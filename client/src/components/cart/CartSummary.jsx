...
const CartSummary = ({ totalPrice, includesFreeShipping }) => {
    const isAuthenticated = useSelector((state) => state.auth.isAuthenticated);
    const subtotalPrice = includesFreeShipping ? totalPrice : totalPrice + 5.99;
    ...
    return (
        <div className='flex flex-col border-2 border-solid border-gray-700 rounded-xl text-center p-5'>
            ...
            <div className='my-4 flex justify-between'>
                ...
                <span className='italic'>{formatPrice(subtotalPrice)}</span>
            </div>
